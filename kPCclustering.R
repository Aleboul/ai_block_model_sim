...
#data=data/nrms
#
#centroids = clusterMeans(data, k = 4)
#print(clusterMeans(data,k=1))
#print(clusterPC(data,k=1,startFromMeans = TRUE))
#print(clusterMeans(data,k=4))
#print(clusterPC(data,k=4))
#print(getClusterIndex(data, centroids))